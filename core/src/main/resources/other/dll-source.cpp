...
extern "C" __declspec(dllexport) void JNICALL Java_tvz_ntpr_ntprproject_utils_NotificationJNI_showNotification(
...
extern "C" __declspec(dllexport) void JNICALL Java_tvz_ntpr_ntprproject_utils_NotificationJNI_playSystemSound(
